          ...
          <div className="container mx-auto">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="inline-flex items-center p-1 bg-dark-300 rounded-full shadow-inner">
                ...
                >
                  Yearly <span className="ml-2 text-xs  px-2 py-0.5 rounded text-white">Save 30%</span>
                </button>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              {pricingPlans.map((plan, index) => (
                <div
                  key={index}
                  className={cn(
                    "glass rounded-2xl overflow-hidden transition-all duration-300 border-2  hover:shadow-2xl hover:scale-105",
                  ...
                  <div className="p-8">
                    ...
                    <div className="mt-8">
                      <div className="flex flex-col gap-3">
                        {plan.popular ? (
                          < button style={{ cursor: 'pointer' }} className="w-full py-1 text-lg font-semibold shadow-md hover:scale-105 transition-transform duration-300 bg-gradient-to-r from-[#3818d6] to-[#a084f9] rounded-xl">
                            {plan.cta}
                          </button>
                        ) : (
                          <button
                          style={{ cursor: 'pointer' }}
                            className={cn(
                              "w-full py-1 text-lg font-semibold shadow-md hover:scale-105 transition-transform duration-300 bg-gradient-to-r from-[#3818d6] to-[#a084f9] rounded-xl",
